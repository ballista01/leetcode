...
// 1 <= n <= 50 
// 
// Related Topics Dynamic Programming 👍 2262 👎 53
...
class Solution {
    public int countVowelStrings(int n) {
        ...
        for (int i = 1; i < n; i++) {
            for (int j = vowelCount.length - 1; j - 1 >= 0; j--) {
                vowelCount[j - 1] += vowelCount[j];
            }
        }
...
// Memory Usage: 39.2 MB, less than 82.38% of Java online submissions for Count Sorted Vowel Strings.